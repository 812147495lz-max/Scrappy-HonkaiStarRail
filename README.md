...
示例视频：  
【Python丐版崩铁再次迭代】 https://www.bilibili.com/video/BV14KcczwExA
...
### 版本迭代
- 2.2:为角色和大招增加了颜色，变的更加美观和直观，此外修复了一些bug
- 2.1:版本将游戏主循环封装入game类中，便于后期维护修改
- 2.0:将原本混乱的运算和输出彻底解耦，并增加时间条显示每一回合的行动顺序
- 1.3:将原本的执行逻辑和输出逻辑进行解耦，为下一步ui开发做好准备
- 1.2：改掉了原本if套else的逻辑，改成了子类继承的方法，优化了代码结构
- 1.1: 修复拉条排序逻辑，解决了可能卡死的问题，解决了出大招会显示多个分隔符的问题，加快了游戏速度，优化 AI 执行流